...
class NetworkInterface(object):
    ...
    def __init__(self, flags=None, id=None, ip_addrs=None, ipv4_gateway=None, ipv6_gateway=None, linklayer=None, lnn=None, macaddr=None, mtu=None, name=None, nic_name=None, owners=None, speed=None, status=None, type=None, vlans=None):  # noqa: E501
    ...
    def ipv4_gateway(self, ipv4_gateway):
        ...
        if ipv4_gateway is not None and not re.search(r'^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$', ipv4_gateway):  # noqa: E501
    ...
    def ipv6_gateway(self, ipv6_gateway):
        ...
        if ipv6_gateway is not None and not re.search(r'^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$', ipv6_gateway):  # noqa: E501
