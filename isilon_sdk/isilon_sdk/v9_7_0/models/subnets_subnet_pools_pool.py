...
class SubnetsSubnetPoolsPool(object):
    ...
    swagger_types = {
        ...
        'ranges': 'list[GroupnetSubnetScServiceAddr]',
    ...
    attribute_map = {
        ...
        'name': 'name',
        'nfsv3_rroce_only': 'nfsv3_rroce_only',
        'ranges': 'ranges',
    ...
    def __init__(self, access_zone=None, addr_family=None, aggregation_mode=None, alloc_method=None, description=None, external_manager=None, firewall_policy=None, groupnet=None, id=None, ifaces=None, ipv6_perform_dad=None, name=None, nfsv3_rroce_only=None, ranges=None, rebalance_policy=None, rules=None, sc_connect_policy=None, sc_dns_zone=None, sc_dns_zone_aliases=None, sc_failover_policy=None, sc_subnet=None, sc_suspended_nodes=None, sc_ttl=None, static_routes=None, subnet=None):  # noqa: E501
        ...
        self.name = name
        self.nfsv3_rroce_only = nfsv3_rroce_only
        self.ranges = ranges
    ...
    def external_manager(self, external_manager):
        ...
        :type: str
        """
        if external_manager is not None and len(external_manager) > 128:
            raise ValueError("Invalid value for `external_manager`, length must be less than or equal to `128`")  # noqa: E501
        if external_manager is not None and len(external_manager) < 0:
    ...
    def firewall_policy(self, firewall_policy):
        ...
        if firewall_policy is not None and len(firewall_policy) > 32:
            raise ValueError("Invalid value for `firewall_policy`, length must be less than or equal to `32`")  # noqa: E501
        if firewall_policy is not None and len(firewall_policy) < 1:
    ...
    @property
    def nfsv3_rroce_only(self):
        """Gets the nfsv3_rroce_only of this SubnetsSubnetPoolsPool.  # noqa: E501

        Indicates that pool contains only RDMA RRoCE capable interfaces.  # noqa: E501

        :return: The nfsv3_rroce_only of this SubnetsSubnetPoolsPool.  # noqa: E501
        :rtype: bool
        """
        return self._nfsv3_rroce_only

    @nfsv3_rroce_only.setter
    def nfsv3_rroce_only(self, nfsv3_rroce_only):
        """Sets the nfsv3_rroce_only of this SubnetsSubnetPoolsPool.

        Indicates that pool contains only RDMA RRoCE capable interfaces.  # noqa: E501

        :param nfsv3_rroce_only: The nfsv3_rroce_only of this SubnetsSubnetPoolsPool.  # noqa: E501
        :type: bool
        """
        if nfsv3_rroce_only is None:
            raise ValueError("Invalid value for `nfsv3_rroce_only`, must not be `None`")  # noqa: E501

        self._nfsv3_rroce_only = nfsv3_rroce_only
    ...
    def ranges(self):
        ...
        :rtype: list[GroupnetSubnetScServiceAddr]
        """
        return self._ranges
    ...
    def ranges(self, ranges):
        ...
        :type: list[GroupnetSubnetScServiceAddr]
        """
        if ranges is None:
