...
class DiagnosticsGatherSettingsExtended(object):
    ...
    def __init__(self, esrs=None, ftp_upload=None, ftp_upload_host=None, ftp_upload_insecure=None, ftp_upload_mode=None, ftp_upload_pass=None, ftp_upload_path=None, ftp_upload_proxy=None, ftp_upload_proxy_port=None, ftp_upload_ssl_cert=None, ftp_upload_user=None, ftp_upload_webui_default=None, gather_begin=None, gather_mode=None, gather_past=None, group=None, http_insecure_upload=None, http_upload=None, http_upload_host=None, http_upload_path=None, http_upload_proxy=None, http_upload_proxy_port=None, supportassist=None, upload=None):  # noqa: E501
        ...
        if supportassist is not None:
            self.supportassist = supportassist
    ...
    def ftp_upload_host(self, ftp_upload_host):
        ...
        :type: str
        """
        if ftp_upload_host is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', ftp_upload_host):  # noqa: E501
    ...
    def ftp_upload_path(self, ftp_upload_path):
        ...
        :type: str
        """
        if ftp_upload_path is not None and len(ftp_upload_path) > 4096:
    ...
    def ftp_upload_proxy(self, ftp_upload_proxy):
        ...
        :type: str
        """
        if ftp_upload_proxy is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', ftp_upload_proxy):  # noqa: E501
    ...
    def ftp_upload_ssl_cert(self, ftp_upload_ssl_cert):
        ...
        :type: str
        """
        if ftp_upload_ssl_cert is not None and len(ftp_upload_ssl_cert) > 4096:
    ...
    def ftp_upload_user(self, ftp_upload_user):
        ...
        :type: str
        """
        if ftp_upload_user is not None and len(ftp_upload_user) > 256:
    ...
    def gather_begin(self, gather_begin):
        ...
        :type: str
        """
        if gather_begin is not None and len(gather_begin) > 255:
    ...
    def gather_past(self, gather_past):
        ...
        :type: str
        """
        if gather_past is not None and len(gather_past) > 255:
    ...
    def group(self, group):
        ...
        :type: str
        """
        if group is not None and len(group) > 8192:
    ...
    def http_upload_host(self, http_upload_host):
        ...
        :type: str
        """
        if http_upload_host is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', http_upload_host):  # noqa: E501
    ...
    def http_upload_path(self, http_upload_path):
        ...
        :type: str
        """
        if http_upload_path is not None and len(http_upload_path) > 4096:
    ...
    def http_upload_proxy(self, http_upload_proxy):
        ...
        :type: str
        """
        if http_upload_proxy is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', http_upload_proxy):  # noqa: E501
    ...
    @property
    def supportassist(self):
        """Gets the supportassist of this DiagnosticsGatherSettingsExtended.  # noqa: E501

        Use SupportAssist for upload of gather.  # noqa: E501

        :return: The supportassist of this DiagnosticsGatherSettingsExtended.  # noqa: E501
        :rtype: bool
        """
        return self._supportassist

    @supportassist.setter
    def supportassist(self, supportassist):
        """Sets the supportassist of this DiagnosticsGatherSettingsExtended.

        Use SupportAssist for upload of gather.  # noqa: E501

        :param supportassist: The supportassist of this DiagnosticsGatherSettingsExtended.  # noqa: E501
        :type: bool
        """

        self._supportassist = supportassist
