...
class GroupnetSubnetExtended(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'prefixlen': 'int',
        'sc_service_addrs': 'list[GroupnetSubnetScServiceAddr]',
        'sc_service_name': 'str',
        'vlan_enabled': 'bool',
        'vlan_id': 'int',
        'addr_family': 'str',
    ...
    def __init__(self, description=None, dsr_addrs=None, gateway=None, gateway_priority=None, mtu=None, name=None, prefixlen=None, sc_service_addrs=None, sc_service_name=None, vlan_enabled=None, vlan_id=None, addr_family=None, base_addr=None, firewall_policy=None, groupnet=None, id=None, pools=None):  # noqa: E501
    ...
    def sc_service_addrs(self):
        """Gets the sc_service_addrs of this GroupnetSubnetExtended.  # noqa: E501

        List of IP addresses that SmartConnect listens for DNS requests.  # noqa: E501

        :return: The sc_service_addrs of this GroupnetSubnetExtended.  # noqa: E501
    ...
    def sc_service_addrs(self, sc_service_addrs):
        """Sets the sc_service_addrs of this GroupnetSubnetExtended.

        List of IP addresses that SmartConnect listens for DNS requests.  # noqa: E501

        :param sc_service_addrs: The sc_service_addrs of this GroupnetSubnetExtended.  # noqa: E501
