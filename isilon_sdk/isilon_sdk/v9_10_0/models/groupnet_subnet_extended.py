...
class GroupnetSubnetExtended(object):
    ...
    def __init__(self, description=None, dsr_addrs=None, gateway=None, gateway_priority=None, mtu=None, name=None, prefixlen=None, sc_service_addrs=None, sc_service_name=None, vlan_enabled=None, vlan_id=None, addr_family=None, base_addr=None, firewall_policy=None, groupnet=None, id=None, linklayer=None, pools=None):  # noqa: E501
    ...
    def linklayer(self, linklayer):
        ...
        if linklayer not in allowed_values:
            raise ValueError(
